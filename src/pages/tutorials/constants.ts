...
export const VIDEOS = 'videos on Nova Trading';
...
export const user_guide_content = (): TUserGuideContent[] => [
    {
        ...
        type: 'Tour',
        subtype: 'OnBoard',
        content: localize('Get started on Nova Trading'),
...
export const guide_content = (): TGuideContent[] => [
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('An introduction to Nova Trading'),
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('How to build a basic trading bot with Nova Trading'),
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: `${localize('How to use')} Martingale ${localize('strategy on Nova Trading')}`,
    ...
    },
    {
        id: 4,
        type: 'DBotVideo',
        content: `${localize('Introducing')} ${localizeAccumulators()} ${localize('Options on Nova Trading: Available for automated trading')}`,
...
export const faq_content = (): TFaqContent[] => [
    {
        title: localize('What is Nova Trading?'),
        description: [
            {
                type: 'text',
                content: localize(
                    "Nova Trading is a web-based strategy builder for trading digital options. It’s a platform where you can build your own automated trading bot using drag-and-drop 'blocks'."
                ),
            },
        ],
        search_id: 'faq-0',
    ...
    {
        title: localize('Do you offer pre-built trading bots on Nova Trading?'),
        description: [
            {
                type: 'text',
    ...
    },
    {
        ...
        description: [
            {
                type: 'text',
                content: `${localize('A quick strategy is a ready-made strategy that you can use in Nova Trading. There are 3 quick strategies you can choose from:')} Martingale, D'Alembert, ${localize('and')} Oscar's Grind.`,
            },
            {
                type: 'text',
    ...
    {
        title: localize('How do I import my own trading bot into Nova Trading?'),
        description: [
            {
                type: 'text',
                content: isGoogleDriveConfigured()
    ...
    {
        title: localize('How do I control my losses with Nova Trading?'),
        description: [
            {
                type: 'text',
                content: localize(
                    'There are several ways to control your losses with Nova Trading. Here’s a simple example of how you can implement loss control in your strategy:'
                ),
            },
            {
                type: 'image',
    ...
    {
        title: localize('Can I run Nova Trading on multiple tabs in my web browser?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Can I trade cryptocurrencies on Nova Trading?'),
        description: [
            {
                type: 'text',
                content: localize("No, we don't offer cryptocurrencies on Nova Trading."),
            },
        ],
        search_id: 'faq-12',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "No, we don't. However, you'll find quick strategies on Nova Trading that'll help you build your own trading bot for free."
                ),
            },
        ],
        search_id: 'faq-13',
    ...
    {
        title: localize('In which countries is Nova Trading available?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('If I close my web browser, will Nova Trading continue to run?'),
        description: [
            {
                type: 'text',
                content: localize('No, Nova Trading will stop running when your web browser is closed.'),
            },
        ],
        search_id: 'faq-15',
    },
    {
        ...
        description: [
            {
                type: 'text',
                content: `${localize('Three of the most commonly used strategies in automated trading are')} Martingale, D'Alembert, ${localize('and')} Oscar's Grind — ${localize('you can find them all ready-made and waiting for you in Nova Trading.')}`,
            },
        ],
        search_id: 'faq-16',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    '<a href="https://www.youtube.com/watch?v=QdI5zCkO4Gk&t=203s" target="_blank">Watch this video</a> to learn how to build a trading bot on Nova Trading. Also, <a href="https://deriv.com/academy/blog/posts/how-to-build-a-basic-trading-bot-with-dbot/" target="_blank">check out this blog post</a> on building a trading bot.'
                ),
            },
        ],
        search_id: 'faq-17',
...
export const quick_strategy_content = (): TQuickStrategyContent[] => [
    {
        ...
        content: [
            `${localize('Exploring the')} Martingale ${localize('strategy in Nova Trading')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} D'Alembert ${localize('strategy in Nova Trading')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Oscar's Grind ${localize('strategy in Nova Trading')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Reverse Martingale ${localize('strategy in Nova Trading')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Reverse D'Alembert ${localize('strategy in Nova Trading')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} 1-3-2-6 ${localize('strategy in Nova Trading')}`,
